...
import { LayoutDashboard, BookOpen, History, Settings, LogOut, HandCoins, User } from 'lucide-react';
import AppIcon from '../tools/AppIcon';

const menuItems = [
  { name: 'Beranda', icon: LayoutDashboard, href: '/dashboard/main' },
          ...
          return (
            <Link 
              ...
              className={`flex items-center gap-3 p-3 rounded-xl text-sm font-bold transition-all ${
                isActive 
                ? "bg-primary text-primary-1 dark:text-bg1 shadow-lg shadow-primary/20" 
