      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm font-medium text-slate-500 dark:text-slate-400">
            ...
            <li><Link href="/catalogs" className="hover:text-primary">Katalog Modul</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="font-bold text-slate-800 dark:text-white mb-6 uppercase text-xs tracking-widest">Legal</h4>
          <ul className="space-y-4 text-sm font-medium text-slate-500 dark:text-slate-400">
            <li><Link href="/privacy-policy" className="hover:text-primary">Kebijakan Privasi</Link></li>
            <li><Link href="/terms-conditions" className="hover:text-primary">Syarat & Ketentuan</Link></li>
          </ul>
        </div>
      </div>
